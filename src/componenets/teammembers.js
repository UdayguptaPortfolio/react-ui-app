    ...
    <>
      ...
      <div className="team-members-bottom">
        <div className="members-heading-bottom">
          ...
          <p>
            "{currentTeamData?.quote}"
          </p>
          <div className="fontawesone-icons">
            <FontAwesomeIcon icon={faSquareCaretLeft} className="cart-icon" onClick={leftClick}/>
            <FontAwesomeIcon icon={faSquareCaretRight} className="cart-icon" onClick={rightClick}/>
          </div>
        </div>
      </div>
